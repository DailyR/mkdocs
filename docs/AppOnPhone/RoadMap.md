...
- 里程碑意义达成，完成了自己的首个开发app应用，完全由自己设计和思考完成的APP
	
	- 2023-02-15 15:57:52 by DailyR 里程碑达成

		- 设计接下来的任务和流程

		- 初步为梳理几个项目相关的测试实际需求和壮大自己的归纳总结和推广能力，形成文章为主的舆论阵地，形成自己的场。


- 2023-04-23 17:29:49 by DailyR

	- App开发，todo list和外网各个项目手机包的下载 （分发放在某百度网盘下载链接）用来做外网项目的掩盖

	- 自己个人日常使用 - 测试组日常使用  2023/04/21 17:23

	- 先起一个新工程，用来存放这个目标的任务

	- 外网真正app目的，接收今天的自动生成文本，在app中获取到自动复制后，粘贴到剪映里（这样就少了一步需要飞书传输的步骤），还可以自己生成改格式，如此完美

	- 关于P30 pro没法上抖音（公司网），可以开iphone 热点流量解决，这样不用搬来搬去了。  —— （有价值的问题和解决方法） （做了再想，这时候才有思考的意义）
