...
--------------------------
 ...
 - 0.5.6 Beta_2版本 (2022.07.15)

    - 继续赶版本（md快成为我的日志了）（0719）
    - 思考观察的过程，比直接获得结果更重要
    - 利弊分析，认知判断
    - 存在问题，到晚上加班（特别是连续加班的时候）就容易头昏脑涨头痛
    - 设定一个目标，形成一个自动化测试专题
    - 思考一下，哈佛幸福课：自信心，好奇心，一个卓越的小群体
    - 8月目标是把一些框架思路，比较说打包机和云测试平台的思路搞定
    - 



 - 0.5.6 Beta_2版本 (2022.07.13)
    - 开始增加第2章任务的自动化测试case
    - 开始写lua脚本和游戏对应关系的笔记，见对应md文件
        - 内网同步外网


 - 0.5.5 Beta_2版本 (2022.06.28)
    - 当前状态：
        - 申请完了外网机，准备增加战斗用例，版本开始提升
        - lowpoly-fight-check
